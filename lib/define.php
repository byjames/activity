...
define('RES_CONFIG_URL', 'http://192.168.181.133/res/config');// config file url
...
define('RES_LOAD_RANKING_URL', 'http://backup.djsh5.com/res/data/'); // get 排行数据脚本文件地址
define('RES_LOAD_RANKING_PATH', $_SERVER['DOCUMENT_ROOT'] . '/res/data/'); //  文件的地址目录
define('ACCEPT_FILE_SCRIPT_URL', 'http://192.168.181.133/res/ranking-load-file.php'); // 远程接收排行榜数据文件脚本url
